...
export const metadata = {
  title:
    "Indian Heritage | Culture, History, Monuments & Tourism – BharatAbroad",
  description:
  ...
  openGraph: {
    title:
      "Indian Heritage for Global Indians | Culture, History, Monuments & Tourism – BharatAbroad",
    description:
    ...
    images: [
      "https://ayg.s3.us-east-2.amazonaws.com/bharatabroad.com-heritage.png",
    ],
  },
  alternates: {
